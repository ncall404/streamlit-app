...
with right_column_2:
    ...
    st.write(character_dictionary[chosen])
...
st.write(f" ### {chosen}'s Racing Profile")
...
if st.checkbox('Show for All Racers'):
    st.write("Stats for All Racers")
    st.bar_chart(df_racer,
                 x='Character',
                 y=['Speed', 'Acceleration', 'Weight', 'Handling', 'Traction/Grip', 'Mini-Turbo'])